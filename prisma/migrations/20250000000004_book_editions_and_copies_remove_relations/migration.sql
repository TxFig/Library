/*
  ...
  - Made the column `editionId` on table `Image` required. This step will fail if there are existing NULL values in that column.
...
-- AddForeignKey
ALTER TABLE "UserBookReadingState" ADD CONSTRAINT "UserBookReadingState_editionId_fkey" FOREIGN KEY ("editionId") REFERENCES "BookEdition"("id") ON DELETE CASCADE ON UPDATE CASCADE;
