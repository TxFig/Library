...
// // import { BookCreateSchema, type BookCreateFormDataInput } from "$lib/_validation/book/_book"
...
//     const book = await db.books.book.getUnique({
//         where: { isbn },
//         include: {
//             publish_date: true,
//             location: true,
...
//         form,
//         imageUrl,
//         allAuthors: await db.books.author.getAll(),
//         allPublishers: await db.books.publisher.getAllPublishers(),
//         allSubjects: await db.books.subject.getAll(),
...
//             try {
//                 info = await api.books.PATCH(form, locals.user!.id)
