...
//     if (env.ADMIN_EMAIL) {
//         try {
//             const doesUserExist = await db.auth.user.getCount({ where: { email: env.ADMIN_EMAIL } }) !== 0
//             if (doesUserExist) {
//                 return {
//                     providedEmail: true,
...
//         try {
//             await db.auth.emailConfirmation.sendEmailAndCreateRequest(user, "/admin")
//         } catch {
//             error(HttpCodes.ServerError.InternalServerError, {
//                 error: undefined,
...
//         try {
//             const doesUserExist = await db.auth.user.getCount({ where: { email: form.data.email } }) !== 0
//             if (doesUserExist) {
//                 return message(form, {
//                     type: "error",
