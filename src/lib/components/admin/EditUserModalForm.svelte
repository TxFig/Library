<script lang="ts">
    ...
    import type { EntireUser, InsertUserInput } from "$lib/server/database/auth"
    ...
    async function updateUserFormSubmit(userId: number, data: InsertUserInput): Promise<EntireUser | undefined> {
