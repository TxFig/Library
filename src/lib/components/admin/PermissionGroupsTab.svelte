<script lang="ts">
    import type { PermissionGroupWithAssociatedPermissions } from "$lib/server/database/auth/permission-group";
    import type { Permission } from "@prisma/client";

    export let permissionGroups: PermissionGroupWithAssociatedPermissions[]
